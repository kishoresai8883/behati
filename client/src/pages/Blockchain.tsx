...
import type { Block } from "@mui/icons-material";

const cloudServices = [
  {
    id: 1,
    title: "Distributed Trust",
    description: "Distributed Trust for a Desirable Digital Experience",
  ...
  },
  {
    id: 2,
    title: "Ethereum",
    description: "Descrover Decentralized Innovation with Ethereum",
  ...
  },
  {
    id: 3,
    title: "Hyperledger",
    description: "An Open-Source Platform for Blockchain Excellence",
  ...
  },
  {
    ...
    description: "Where Privacy Empowers & Integrity Prevails",
  ...
  },
  {
    id: 5,
    title: "NFT",
    description: "A New Frontier for your Digital Assets",
  ...
  },
  {
    id: 6,
    title: "IPFS",
    description: "Redefining Data Security with Decentralized Brilliance",
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Trust Meets Transparency With
            <span className="block bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Blockchain
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-6xl mx-auto leading-relaxed">
            Unchain the trail to decentralize the future. Discover the future with secure blockchain solutions.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            VDart Digital offers expert guidance in blockchain technology, crafting tailored solutions that add value.
          </p>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            The Ultimate Destination for all your Blockchain Solutions
          </h2>
