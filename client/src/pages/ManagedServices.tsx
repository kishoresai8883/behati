...
const cloudServices = [
  {
    ...
    description: "Secure, monitor, and manage — proactively.",
    color: "from-blue-500 to-cyan-500",
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&h=300&fit=crop"
  },
  {
    id: 2,
    title: "Strategic IT Consulting & Continuous Improvement",
    description: "Technology that adapts to your goals.",
    color: "from-purple-500 to-pink-500",
    image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&h=300&fit=crop"
  },
  {
    id: 3,
    title: "Infrastructure & Data Center Management",
    description: "Engineered for uptime and continuity.",
    color: "from-green-500 to-emerald-500",
    image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=400&h=300&fit=crop"
  },
  {
    id: 4,
    title: "End-User Support & Device Management",
    description: "Reliable support for a seamless employee experience.",
  ...
  },
  {
    ...
    description: "Flexible infrastructure for agile teams.",
  ...
  },
  {
    ...
    description: "Structured processes for smooth delivery.",
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-6xl mx-auto leading-relaxed">
            Drive performance, resilience, and innovation across your organization with our tailored IT Managed Services.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            VDart Digital brings deep technical expertise, proactive support, and strategic alignment. We don’t just fix issues—we help you future-proof your IT environment.
          </p>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            VDart Digital delivers enterprise-grade IT services without the overhead—so you can scale smarter, stay secure, and focus.
          </h2>
