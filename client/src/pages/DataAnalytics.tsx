...
const cloudServices = [
  {
    ...
    description: "Embrace the IoT-Driven Future with VDart Digital",
  ...
  },
  {
    id: 2,
    title: "AI/NLP",
    description: "Unlock AI Solutions for Seamless Success in Customer Service & Security",
  ...
  },
  {
    ...
    description: "A Vision to Transcend your Journey with Data & Analytics",
  ...
  },
  {
    id: 4,
    title: "Speech",
    description: "Accelerating Speech to Spell Performance",
  ...
  },
  {
    id: 5,
    title: "ML/MLOps",
    description: "Embark on a Transformative Journey of Data-Driven Excellence",
  ...
  },
  {
    id: 6,
    title: "Data Science",
    description: "Leveraging Data Science for a Tactical Data & Analytics Strategy",
  ...
  },
  {
    id: 7,
    title: "Analytics",
    description: "Proven Analytics to Future Proof your Business",
  ...
  },
  {
    id: 8,
    title: "Reports",
    description: "Empower your Businesses with Actionable Insights by Unlocking Data's Potential",
    color: "from-violet-500 to-purple-500",
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&h=300&fit=crop"
  },
  {
    id: 9,
    title: "Big Data & Data Lake",
    description: "Transform your Business with Data-Driven Success with VDart Digital",
    color: "from-blue-500 to-cyan-500",
    image: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&h=300&fit=crop"
  },
  {
    id: 10,
    title: "Data Fabric",
    description: "Unlock New Possibilities with Data Fabric Solutions",
    color: "from-purple-500 to-pink-500",
    image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&h=300&fit=crop"
  },
];
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            ...
            with Profitable Business Outcomes
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-6xl mx-auto leading-relaxed">
            Apply a data-driven approach to improve your business smarter and faster.
          </p>
