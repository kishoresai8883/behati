...
const cloudServices = [
  {
    ...
    description: "Elevate your Software Journey with Expert QA",
  ...
  },
  {
    id: 2,
    title: "Agile Testing",
    description: "Effective Testing for Efficient Progress",
  ...
  },
  {
    ...
    description: "Elevating Software Excellence with Cutting-Edge Certification",
  ...
  },
  {
    ...
    description: "Prominent Testing to Triumph Software Execution",
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-6xl mx-auto leading-relaxed">
            Leverage a high-velocity automation and extract more insights from AI-driven analytics.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            VDart Digital is dedicated to providing a comprehensive range of quality engineering services tailored to meet unique business and IT requirements.
          </p>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Re-Invent Quality & Re-Shape Workforce
          </h2>
